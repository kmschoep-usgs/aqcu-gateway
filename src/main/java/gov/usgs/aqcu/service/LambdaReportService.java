...
public class LambdaReportService {
     ...
     * 
     * 1. If an error occurrs inernally while the SDK attempts to invoke the Lambda that error will be
     ...
     * 
     * @param result The InvokeResult instance recieved from AWSLambda.invoke(..)
